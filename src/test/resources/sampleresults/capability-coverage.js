...
function init() {
    //init data
    var json = {"children":[{"children":[],"data":{"progress":66,"tests":9,"pending":4,"$color":"#63ff15","$area":60,"steps":60,"failing":0,"type":"tag","passing":5},"id":"learn word definitions","name":"learn word definitions"}],"data":{},"id":"root","name":"Application"};
    //end
    //init TreeMap
